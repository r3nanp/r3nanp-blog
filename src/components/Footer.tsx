    ...
    <footer className="flex items-center justify-center flex-col pb-2 md:flex-row">
      ...
      <Link href="https://github.com/r3nanp/r3nanp-blog">
        <a rel="noopener noreferrer" target="_blank">
          <motion.div whileHover={{ scale: 1.2 }} className="mx-4 flex items-center justify-center rounded-md shadow-md hover:opacity-70 px-2 bg-gradient-to-r from-gray-200 via-gray-300 to-gray-400">
